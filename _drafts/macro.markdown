...
Keep the flash as near as possible to the subject.
...
It takes really a lot of time. To spray cold water helps, but not so much. I don't shot to dead insect. Try to go outside at the sunrise (I've never done it).
...
A really big problem with low-end cameras is the [buffer](https://www.lifewire.com/camera-image-buffer-492951) size. This can limitate the number of continuous brust shots that you can take. With the `D3100`, after a brust of ~10 images, I had to wait ~20 seconds so that the camera elaborate the photos.
